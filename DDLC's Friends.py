...
def SelectFen(FENETRE):
    ...
    canvas.create_text(200, 20, text="Choisis ton amie de compagnie", font=("Times New Roman", 20, "bold"), fill = '#ff0000')
...
def Main():
    ...
    backgroundImage=ImageTk.PhotoImage(Image.open("files/images/frame.png"))
    canvas.create_image(203, 180, image = backgroundImage)
    canvas.create_text(200, 50, text="DDLC's Friends", font=("Times New Roman", 35, "bold"), fill = '#ff0000')
